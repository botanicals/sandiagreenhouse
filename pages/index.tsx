...
const IndexPage: NextPage<IndexPageProps> = ({ name, metadata, sections }) => {
  return (
    <div className="flex flex-col justify-between bg-light">
      ...
      <main>
        ...
        <h1 className="mx-auto my-8 text-4xl font-bold text-primary max-w-7xl">Sandia Greenhouse</h1>

        <section className="grid gap-8 mx-auto my-8 md:grid-cols-2 max-w-7xl">
          <div className="space-y-4">
            <p>
              Sandia Greenhouse has been the leading local grower in Southern Utah for over 40+ years. Owned and Operated by Larry Hancock, Sandia specializes in local grown plants that thrive in our
              local climate.
            </p>

            <p>
              Not only do Southern Utahan’s flock to Sandia as their best source of bedding plants, vegetables, trees, and Christmas Poinsettias. But loyal customers even come all the way from Nevada,
              Arizona, and in some cases even Central and Northern Utah.{' '}
            </p>

            <p>
              Many big box stores bring in plants from other climates. This almost inevitably results in sub-par growth or the plants dying shortly after planting. At Sandia Greenhouse you can count
              on getting plants that are acclimated and ideally suited for our desert climate.{' '}
            </p>

            <p>So come see us today at 4234 S. Washington Fields Road for your plant and growing needs. </p>
          </div>
          <div>
            <figure className="w-full h-auto">
              <img src="/assets/greenhouse-interior.jpg" alt="greenhouse interior" />
            </figure>
          </div>
        </section>
      </main>
            ...
            <div className="lg:col-span-2">
              <div className="md:grid md:grid-cols-3 md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="mb-4 text-sm font-bold tracking-wider uppercase">Hours</h3>
